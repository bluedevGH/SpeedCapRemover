...
This is only the source code file, you must compile it yourself for it to run, I will create a .dll release when it is in a functional state that I am happy with.
This mod is completely open source and I do not care if you alter the code or suggest updates to it, feel free!
